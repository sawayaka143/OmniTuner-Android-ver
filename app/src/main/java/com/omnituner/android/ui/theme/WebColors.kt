...
object WebColors {
    ...
    val Dark = WebPalette(
        ...
        needleColor = Color(0xFFF5F5F3),
        inTuneColor = Color(0xFFEDE8D0),
        outOfTuneColor = Color(0xFFFF8AAB),
        dialWell = Color(0xFF000000),
        dialFace = Color(0xFF1F1F1E),
        ...
        inTuneText = Color(0xFFEDE8D0),
        fretboardNote = Color(0xFF3B3B3B),
    )
    ...
    val Light = WebPalette(
        ...
        needleColor = Color(0xFF1A1A18),
        inTuneColor = Color(0xFFEDE8D0),
        outOfTuneColor = Color(0xFFB01645),
        dialWell = Color(0xFFDEDBD4),
        dialFace = Color(0xFFFBFAF8),
        dialSheen = Color(0xFFFFFFFF),
        dialShadow = Color(0xFF000000),
